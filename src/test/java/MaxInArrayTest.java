...
//
//        double[] actualResult = new MaxInArray().maxInArray(array1, array2);
//
//        Assert.assertEquals(actualResult, expectedResult);
//
//    }

        private static Stream<Arguments> masInArrayProvider() {
        ...
        @ParameterizedTest
        @MethodSource("masInArrayProvider")
        public void testHappyNumber(double[] array1, double[] array2, double[] expectedResult) {
